...
file = open('C:\\Users\\biubiubiu\\Desktop\\sumo_data\\normal_data.csv','r',encoding = 'UTF8', newline = '')
col = csv.DictReader(file)  
...
vehicle_index_map = {}
all_vehicle_id = set()
for vehicle in col.find({}, {"vehicle_id": '1', "timestamp": '2'}):
...
np.savetxt(r'sumo/normal.content', np.array(features_output), encoding='utf-8', fmt='%s')
...
np.savetxt(r'sumo/normal.cites', np.array(adj_output), encoding='utf-8', fmt='%s')
f = open("sumo/README_normal", "w")
